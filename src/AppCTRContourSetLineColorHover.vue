<template>
    <div>
        ...
        <div class="bkh">
            ...
            <a href="//yuda-lyu.github.io/w-maplibregl-vue/examples/ex-AppCTRContourSetLineColorHover.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-maplibregl-vue/blob/master/docs/examples/ex-AppCTRContourSetLineColorHover.html" target="_blank" class="item-link">code</a>
        </div>
