<template>
    <div>
        ...
        <div class="bkh">
            ...
            <a href="//yuda-lyu.github.io/w-maplibregl-vue/examples/ex-AppPGNPolygonSetChangeData.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-maplibregl-vue/blob/master/docs/examples/ex-AppPGNPolygonSetChangeData.html" target="_blank" class="item-link">code</a>
        </div>
...
export default {
    ...
    data: function() {
        ...
        // let latLngs6 = [ //此結構代表1個multiPolygon
        //     [
        //         [ //add p1
        //             [24.96, 121.41], [25.11, 121.47], [25.06, 121.69], [24.99, 121.61], [24.95, 121.53]
        //         ],
