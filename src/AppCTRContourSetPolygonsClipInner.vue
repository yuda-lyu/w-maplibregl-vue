<template>
    <div>
        ...
        <div class="bkh">
            ...
            <a href="//yuda-lyu.github.io/w-maplibregl-vue/examples/ex-AppCTRContourSetPolygonsClipInner.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-maplibregl-vue/blob/master/docs/examples/ex-AppCTRContourSetPolygonsClipInner.html" target="_blank" class="item-link">code</a>
        </div>
...
export default {
    ...
    data: function() {
        let polygonsClipInner = [ //此結構代表1個polygon
            [
        ...
        // let polygonsClipInner = [ //此結構代表1個multiPolygon
        //     [
        //         [
        //             [24.28, 120.842], [24.494, 121.203], [24.314, 121.190], [24.232, 121.109], [24.249, 120.910],
        //         ],
